...
public class UMengUtils {
    ...
    //开机时候音量
    public static final String EVENT_VOL_BOOT = "vol_boot";
    //大耳朵插入是否正确
    public static final String EVENT_AI_MIC_PLUG= "ai_mic_plug";
    //大耳朵插入成功率
    public static final String EVENT_AI_MIC_PLUG_RATE = "ai_mic_plug_rate";
    //大耳朵外脑版本
    public static final String EVENT_AI_MIC_VERSION = "ai_mic_version";
    //大耳朵拔出
    public static final String EVENT_AI_MIC_INJECT = "ai_mic_inject";

    //每次开机统计是否连接外脑
    public static final String EVENT_STATUS_AI_MIC = "status_ai_mic";
    //每次开机统计是否连接遥控器
